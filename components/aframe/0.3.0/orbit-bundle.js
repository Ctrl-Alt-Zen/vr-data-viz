  ...
  updateOrientation: (function () {
    ...
    return function () {
      ...
      this.el.setAttribute('rotation', {
        x: THREE.Math.radToDeg(hmdEuler.x) + THREE.Math.radToDeg(pitchObject.rotation.x * 2),
        y: THREE.Math.radToDeg(hmdEuler.y) + THREE.Math.radToDeg(yawObject.rotation.y * 2),
        z: THREE.Math.radToDeg(hmdEuler.z) + THREE.Math.radToDeg(yawObject.rotation.z * 2)
      });
    };
  })(),
...
},{"aframe-orbit-controls-component":1}]},{},[2]);
